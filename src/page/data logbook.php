...
<body>
  ...
  <caption><h2><b><center>DATA LOGBOOK AREA SCRAP TERCATAT</center></b></h2></caption>
  <thead class="table table-bordered" style="background-color: #f0f0f0;">
    <tr style="text-align: center; background-color: #e0e0e0;">
            ...
            <td style="width: 5%; background-color: #ffb47a;">Hapus</td>
          </tr>
        </thead>
            ...
            <?php
                ...
                while ($tampil = mysqli_fetch_array($ambildata)) {
                    ...
                    <tr>
                        ...
                        <td style='text-align: center;'>$tampil[Bagian]</td>   
                        ...
                        <td style='text-align: center; vertical-align: middle;'><button style='background-color: #FF0000; color: #FFFFFF; border: none; padding: 5px 10px; border-radius: 5px; cursor: pointer; display: inline-block;'><a href='?kode=$tampil[Nama]' style='text-decoration: none; color: #FFFFFF;'>Hapus</a></button></td> 
                    </tr>";
                    $no++;
                }
