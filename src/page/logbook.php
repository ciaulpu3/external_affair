...
<head>
    ...
    <title>Logbook Area Scrap</title>
    <link rel="stylesheet" href="bootstrap-5.3.3-dist/css/bootstrap.min.css">
    <style>
      .banner {
        height: 100vh;
        background: linear-gradient(rgba(124, 124, 124, 0.5), rgba(157, 157, 157, 0.5)), url(../photos/scrap\ bg.jpg);
      ...
      <div class="container banner-content col-lg-6">
        ...
        <!-- FORM START -->
          <div class="container mt-5 pt-4 sticky-top" style="padding-top: 60px;">
            <h3 style="color: white;"><center>Form Logbook Area Scrap</center></h3>
            ...
            <form action="" method="post">
                  ...
                  <div class="mb-3 row">
                    <label for="inputbagian" class="col-sm-2 col-form-label text-white">Bagian</label>
                    <div class="col-sm-10">
               ...
               <button type="submit" class="btn btn-primary" name="logbook" value="Tambah Data">Submit</button>
            </form>
           </div>
        <!-- FORM END -->
